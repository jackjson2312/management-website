...
<body>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">ĐĂNG NHẬP TRANG QUẢN TRỊ</h1>
            <div class="account-wall">
                ...
                <input class="btn btn-lg btn-primary btn-block" type="submit" name="submit" value="ĐĂNG NHẬP"></input>
                <label class="checkbox pull-left">
                    <input type="checkbox" value="remember-me">
                    Nhớ lần sau
                </label>
                <a href="#" class="pull-right need-help">Cần trợ giúp? </a><span class="clearfix"></span>
                </form>
            </div>
