...
<div id='flipkart-navbar'>
    <div class='container'>
        ...
        <div class='row row2'>
            <div class='col-sm-2'>
                <h2 style='margin:0px;'><span class='smallnav menu' onclick='openNav()'>☰ IZShop</span></h2>
                <h1 style='margin:0px;'><span class='largenav'>IZShop</span></h1>
            </div>
